...
public class DividerItemDecorationChooser extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecorationChooser(Context context) {
        this(context, VERTICAL_LIST, -1, -1);
    }

    public DividerItemDecorationChooser(Context context, int orientation) {
        this(context, orientation, -1, -1);
    }

    public DividerItemDecorationChooser(Context context, int orientation, int padding, int dividerHeight) {
    ...
    public DividerItemDecorationChooser(Context context, int orientation, int startpadding, int endpadding, int dividerHeight) {
        setOrientation(orientation);
        mContext = context;
